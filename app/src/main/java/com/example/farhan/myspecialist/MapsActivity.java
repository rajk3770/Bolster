...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    // not granted.
    private final LatLng mDefaultLocation = new LatLng(19, 72);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            //Log.e("LAST LOCATION", mLastKnownLocation.toString());
            // Log.e("CHECK","HI");
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            currentLocationmMarker = mMap.addMarker(markerOptions1);
                            ...
                            Log.e("Output1", "Current location is null. Using defaults.");
                            Log.e("Output2", "Exception: %s", task.getException());
